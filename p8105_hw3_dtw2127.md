...
```
    ...
    ## Adding missing grouping variables: `geo_location`

    ## Warning: Removed 1 row(s) containing missing values (geom_path).

<img src="p8105_hw3_dtw2127_files/figure-gfm/unnamed-chunk-8-1.png" width="90%" />
...
<img src="p8105_hw3_dtw2127_files/figure-gfm/unnamed-chunk-9-1.png" width="90%" />
